...
**References:** ATP 3-21.8, FM 3-90-1, ATP 3-21.20, ADRP 1-02

**OPERATIONAL PLAN / ORDER #005 / CODE NAME: "HOLD THE LINE"**
...
**2. Disposition.** REAPER assault force is staging north of COP Seggel in the vicinity of Jacksonville Street. REAPER indirect fire elements are positioned in the dense forest north of Jacksonville Street. Reconnaissance elements are observing COP Seggel from the woodlines to the north and west, mapping defensive positions and reporting to the assault commander. A secondary assault element may approach from the west through the woodlines.

**3. Most Probable Course of Action (MPCOA).** REAPER initiates with indirect fire (mortars) on COP Seggel to suppress defensive positions and force personnel into cover. Following the barrage, a squad-sized assault element attacks south along the Bradenton Avenue corridor from the Jacksonville Street junction while a second element probes the western perimeter through the woodlines. REAPER attempts to breach the perimeter at the ECP and along the northern boundary.

**4. Most Dangerous Course of Action (MDCOA).** REAPER conducts a coordinated two-axis attack: the main assault from the north along Bradenton Avenue, supported by sustained indirect fire, while a flanking element attacks simultaneously from the west through the woodlines. REAPER employs IEDs or obstacles along Bradenton Avenue south of the COP to prevent friendly withdrawal or reinforcement. The attack is preceded by a feint from the east to draw defensive forces away from the main effort.

### d. Friendly Forces

**1. Higher Headquarters:** 4th BN – 211th INF.

**2. Company Mission.** A Company defends COP Seggel to maintain the forward operating base and preserve combat capability for follow-on operations in AO HERRERA.

**3. Adjacent Units.** No reinforcement is available in the next 12 hours. 2nd Platoon remains OPCON to battalion reserve. 3rd Platoon is unable to support. 1st Platoon must defend with organic assets.

### e. Civil Considerations
Civilians may be displaced by the fighting. Do not engage unidentified personnel without positive identification. Report any civilian presence in or near the defensive perimeter.
...
- **TASK:** Defend COP Seggel against REAPER counterattack from the north and west. Establish fighting positions with overhead cover and interlocking fields of fire. Establish observation posts forward of the perimeter to provide early warning of the REAPER approach. Maintain the ECP and control access to the COP. Plan and rehearse engagement areas along the most dangerous avenues of approach. Maintain a reserve / QRF to respond to penetrations or unexpected threats. Keep the company CP operational throughout the attack. Plan indirect fires on likely REAPER assault positions and routes.
- **PURPOSE:** Retain COP Seggel as the company's forward operating base and destroy the REAPER counterattack force to set conditions for follow-on offensive operations.

### e. Coordinating Instructions

**1. Rules of Engagement (ROE):**
   1. Engage confirmed enemy combatants posing a threat.
   2. Positively identify targets before firing — particularly at the ECP.
   3. Challenge unknown personnel using challenge and password.
   4. Coordinate fires to prevent fratricide between defensive sectors.
   5. Report civilian presence immediately.

**2. Priority Intelligence Requirements (PIR):**
   1. Determine REAPER assault force size, composition, and axis of attack.
   2. Identify REAPER indirect fire positions, particularly north of Jacksonville Street.
   3. Detect REAPER reconnaissance or probes of the COP perimeter.
   4. Identify REAPER obstacles or IED emplacement on routes south of the COP.
   5. Determine whether REAPER is conducting a feint or the main attack.

**3. Commander's Critical Information Requirements (CCIR):**
   1. REAPER force detected moving toward COP Seggel
   2. Indirect fire impacting COP Seggel
   3. Penetration of the COP perimeter at any point
   4. Loss of communications with the company CP
   5. Friendly casualties exceeding 20% in any defensive sector
   6. OP/LP compromised or overrun

**4. Reporting:**
   - **Report when defensive positions are established and ready.**
   - **OP/LP Reports:** Report any enemy movement or activity.
   - **Contact Report:** Upon first engagement with REAPER.
   - **SALUTE Report:** Upon each enemy sighting.
   - **SITREP:** Every 30 minutes during the attack, or upon significant events.
   - **ACE/LACE Report:** Upon repelling the attack.

**5. Defensive Priorities of Work:**
   1. Security (sectors of fire, OP/LPs, ECP)
   2. Fighting positions with overhead cover
   3. Engagement area planning and rehearsal
   4. Indirect fire planning
   5. QRF rehearsal
   6. Sustainment (water, ammo redistribution, rest plan)
...
### a. Logistics
1. Resupply not available during the defense. Redistribute ammunition as needed.
2. Water available at COP Seggel.
3. Class V: Carry full basic load. Report shortages immediately.
4. Prepare for extended defense — rest plan must sustain the force.

### b. Health System Support
1. CCP at COP Seggel within a hardened structure.
2. Aid bag at the CP.
3. MEDEVAC available via Nine Line request at AXP 1.
4. Primary CASEVAC route south along Bradenton Avenue (if not interdicted).
...
2. 1st Platoon Leader has tactical command of the defense.
