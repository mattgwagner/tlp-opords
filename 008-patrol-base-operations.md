...
## ANNEX A: PATROL BASE SITE SELECTION CRITERIA

The following criteria should be evaluated during leader's reconnaissance:

1. **Defensibility:** Terrain supports defense; good fields of fire; covered withdrawal routes.
2. **Concealment:** Site not visible from likely enemy observation points; overhead concealment from aerial observation.
3. **Covered Routes:** Multiple covered and concealed routes into and out of the patrol base.
4. **Away from Key Terrain:** Not on obvious terrain features that enemy would likely reconnoiter.
5. **Away from LOCs:** Not adjacent to roads, trails, or waterways that facilitate enemy movement.
6. **Water Availability:** Near but not on a water source.
7. **Supports Mission:** Positioned to facilitate follow-on operations without significant movement.

---

## ANNEX B: PATROL BASE OCCUPATION TECHNIQUES

**Triangle Formation:**
- Used when terrain permits equal distribution of squads.
- Each squad occupies one point of the triangle.
- PL/PSG CP at center.
- Best for short-duration patrol bases (less than 24 hours).

**Cigar-Shaped Formation:**
- Used in restrictive terrain (draws, ridgelines).
- Squads arranged in elongated perimeter.
- Provides better all-around security in confined terrain.
- Best when terrain canalizes the patrol base site.
